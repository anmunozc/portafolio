...
<div style="text-align:center; padding: 40px 10px; background: linear-gradient(135deg, #0a192f, #12294b); border-radius: 20px; color: white; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
  <img src="projects/auditoria-botium-toys/assets/banner_portafolio.jpg" alt="Banner del portafolio de Andrea Muñoz" style="width:90%; max-width:800px; border-radius: 12px; margin-bottom: 20px;">
